...
def run_loop(symbol,
      ...
      # module = importlib.import_module('src.strategies.1-MACD_Cross.strategy')
      # my_class = getattr(module, 'BaseStrategy')
      # my_instance = my_class()
      # moduleName = 'src.strategies.1-MACD_Cross.strategy'
      ...
      module = importlib.import_module('src.strategies.1-MACD_Cross.strategy')
      strategy_class = getattr(module, 'BaseStrategy')
      
      if opt_mode == 1:
            eval(f"cerebro.optstrategy({cerebro_strategy_params})")
      else:
            eval(f"cerebro.addstrategy({cerebro_strategy_params})")
